                                ...
                                <tr>
                                    <td style="padding:0 0 24px 0;">
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                <td style="padding:10px 0;border-top:1px solid #e4e4e7;font-size:13px;color:#71717a;">Revisado</td>
                                                <td style="padding:10px 0;border-top:1px solid #e4e4e7;font-size:13px;color:#18181b;font-weight:500;text-align:right;">{{ $reviewedAt }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
