...
<head>
    ...
    <title>Documento aprobado - UTSLRC</title>
</head>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td style="padding:0 0 24px 0;font-size:14px;color:#52525b;line-height:1.6;">
                                        {{ $adminName }} reviso tu documento y fue <strong style="color:#16a34a;">aprobado</strong>. Ya se encuentra disponible en tu historial.
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:0 0 24px 0;">
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                <td style="padding:10px 0;border-top:1px solid #e4e4e7;font-size:13px;color:#71717a;">Enviado</td>
                                                <td style="padding:10px 0;border-top:1px solid #e4e4e7;font-size:13px;color:#18181b;font-weight:500;text-align:right;">{{ $submittedAt }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
